...
//        Customer password: fakepass
        loginPage.emailLink.sendKeys("fake@bluerentalcars.com");
        ReusableMethods.waitFor(3);
        loginPage.passwordLink.sendKeys("fakepass");
        ReusableMethods.waitFor(3);
...
//        Customer password: fakepass
        ...
        loginPage.emailLink.sendKeys(fakeEmail);
        ReusableMethods.waitFor(3);
        loginPage.passwordLink.sendKeys(faker.internet().password(4,6));//fake pass 4-6 digit
        ReusableMethods.waitFor(3);
        loginPage.buttonLink.click();
        ReusableMethods.waitFor(3);
//        Error: User with email fake@bluerentalcars.com not found
